  ...
  return (
    <>
      <div
        ...
        className="bg-white/10 backdrop-blur overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full h-full flex items-center flex-col transition-all"
      >
